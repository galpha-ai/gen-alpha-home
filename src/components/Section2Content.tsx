...
export default function Section1Content({
  ...
  return (
    <>
      <div className="absolute inset-0 flex items-center justify-center top-[0vmin]">
        ...
        <div className="absolute right-[35vw] top-[10vw] w-[55vmin] h-[55vmin]">
          <Image
      ...
      >
        <div className="flex flex-row gap-8 justify-between">
          <div className="text-[100px] font-[300] leading-[1.25] text-[#232323] font-helvetica w-[700px]">
            Refines Data into Intelligence
          </div>
          <div className="text-[22px] font-[300] leading-[1.24] text-[#232323] w-[550px] mt-[120px] mr-[40px] text-right ">
            Agentic intelligence and predictive intelligence powered by private
            data
          </div>
        </div>
        <FooterContent />
